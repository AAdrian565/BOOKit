            ...
            <div class="card-body">
              ...
              <form action="{{ route('Room.update', $data->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Email" name='date' value="{{ $data->Email }}">
                </div>
                <div class="mb-3">
                    <label class="mb-2">Phone</label>
                    <input type="text" class="form-control" placeholder="Enter Phone" name='timeStart' value="{{ $data->Phone }}">
                </div>
                  <button type="submit" class="btn btn-outline-light bi bi-save"> Update</button>
                  <a href="{{ route('Room.index') }}" class="btn btn-outline-light bi bi-box-arrow-left"> Return</a>
               </form>
